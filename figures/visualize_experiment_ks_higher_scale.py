...
plt.savefig("figures/kernel_size_experiment_accuracy_and_precision_higher_starting_scale.pdf", format="pdf", bbox_inches="tight")
...
plt.savefig("figures/kernel_size_experiment_time_higher_starting_scale.pdf", format="pdf", bbox_inches="tight")
