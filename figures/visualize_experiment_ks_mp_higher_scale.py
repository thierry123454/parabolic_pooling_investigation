...
fig.legend()
fig.suptitle("Scales learned for different window sizes with all starting scales being 3 using the MP SE.", fontsize=20)
fig.tight_layout()
...
plt.legend()
plt.title("Accuracy and precision versus the window size with all starting scales being 3 using the MP SE.", fontdict={'fontsize': 15})
...
plt.title("Time taken to train in seconds versus the window size with all starting scales being 3 using the MP SE.", fontdict={"fontsize": 15})
