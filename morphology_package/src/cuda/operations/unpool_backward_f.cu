...
/*
There is an issue in the forward pass: If we were purely concerned with sampling, there
...
I see no way of fixing it, let's keep it as an (insignificant) edge-case for now.
*/
...
torch::Tensor unpool_backward_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES(delta_up.scalar_type(), "unpool_backward_cuda", ([&] {
