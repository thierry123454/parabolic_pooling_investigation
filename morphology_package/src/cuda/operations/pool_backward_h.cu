...
__global__ void pool_backward_h_kernel(
...
torch::Tensor pool_backward_h_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES(delta_up.scalar_type(), "pool_backward_h_cuda", ([&] {
    pool_backward_h_kernel<scalar_t><<<blocks, THREADS>>>(
